...
texto1 = Label(root, text='Insira o arquivo que o programa irá ler.', font=("Arial Black",11),background='#B0E0E6')
...
btn2 = Button(root, text='start', command=start ,width=8,font=('Arial',10))
