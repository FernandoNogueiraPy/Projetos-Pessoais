...
import threading
from src.extract import Iniciar, OpenFile, Openfile_2, stop, iniciar2
...
btn5 = Button(tb2, text='Open',command= Openfile_2 , width=8)
btn5.place(x=380,y=50)

btn6 = Button(tb2, text='Enviar',command= salvar_nome2, width=8)
