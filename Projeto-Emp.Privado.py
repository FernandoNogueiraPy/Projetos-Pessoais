...
while True:
  ...
  #Seleciona o documento nescessario.
  if escolher_docs == '0':
  ...
  elif escolher_docs == '1':
    print('Certidão Falencias Sendo executada...')
    falencias()

  elif escolher_docs == '2':
    print('Certidão Civeis Sendo executada...')
    civeis()
    
  elif escolher_docs == '3':
    print('Certidão SAJ5 Sendo executada...')
    saj5()     
      
  elif escolher_docs == '4':  
    print('Certidão Ações Sendo executada...')
    acoes() 

  elif escolher_docs == '5':
    print('Certidão SIVEC Sendo executada...')
    sivec()
    
  elif escolher_docs == '6':
    print('Programa encerrado , Obrigado por usar.')
    break 


#versão atualiada
#A página tem reCaptcha e estava reconhecendo a automação , foi adicionado pausas entre as
#ações da autoamação para que seja possivel passar direto pelo reCaptcha da página.
